...
namespace BraneCloud.Evolution.EC.App.Lawnmower
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ECActivator.AddSourceAssemblies(new[] { Assembly.GetAssembly(typeof(IEvolutionState)), Assembly.GetAssembly(typeof(Lawnmower)) });

            Evolve.Run(new[] { "-file", @"Params\App\Lawnmower\ge2.params" });
            Console.WriteLine("\nDone!");
            Console.ReadLine();
        }
    }
